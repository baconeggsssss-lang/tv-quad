...
A lightweight static web app that shows six live news streams at once from a rotating pool of 25 global channels. Each page load reshuffles the source mix, keeps one feed active with audio, and rotates muted variants automatically to mimic a live newsroom wall.

## Features

- 6 live video tiles displayed simultaneously
- 25 international news sources, reshuffled on every page load
- Six tiles receive four or five channels each
